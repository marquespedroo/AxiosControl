      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
            <p>Selecione um teste para ver os resultados ou clique em &quot;Novo Teste&quot;.</p>
        ...
        < div className="p-6" >
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-3 rounded-xl border transition-all ${isFiltersOpen || hasActiveFilters
